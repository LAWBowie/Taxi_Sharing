...
// Define the success callback function for taking photo
function onSuccess(imageData) {
    // Set the source attribute of the image element to the image data
    imageElement.src = "data:image/jpeg;base64," + imageData;
}

// Define the failure callback function for taking photo
...
function openCamera() {
    if (navigator.camera) {
        ...
        // Call the camera function to open the camera
        navigator.camera.getPicture(onSuccess, onFail, options);
    } else {
        alert('Camera object not defined.');
    }
}
...
function takePhoto() {
    if (navigator.camera) {
        // Call the camera function to take a photo
        navigator.camera.getPicture(onSuccess, onFail, options);
    } else {
        alert('Camera object not defined.');
    }
